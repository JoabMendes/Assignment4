...
Bugs:
	I wrote and executed my program in a macbook, the bug that I found was caused by the atoi() function.
	(Line 44 of player.c)
	The function returns the parameter in an integer format, but but itwas multiplicated by 10, for some unknown reason. I just had to divide the return by 10. As I'm sending this program to be executed in linux, I removed
	this division in the code before submit it.
